    ...
    >
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col items-start gap-2">
          <Link
            to="/"
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-yellow-500"
          >
          ...
          <Link
            ...
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-yellow-500"
          >
            <FaPhone className="text-yellow-500" /> (+98-21) 22542971
          </Link>
          <Link
            to="mailto:example@gymate.com"
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-yellow-500"
          >
            <FaEnvelope className="text-yellow-500" /> example@gymate.com
          </Link>
        </div>
      </section>
      <section className="space-y-4">
        ...
        <div className="flex gap-3">
          <Link className="rounded-full bg-yellow-500 p-3 text-white">

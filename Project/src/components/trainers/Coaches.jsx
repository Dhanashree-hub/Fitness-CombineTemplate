...
const imageBoxStyles = `relative h-72 w-full bg-[url('./images/trainers/freepik-export-20241203145815gQ6y.jpeg')] bg-cover bg-no-repeat before:absolute before:z-10 before:h-full before:w-full 
before:bg-top before:bg-no-repeat before:grayscale before:transition-all before:duration-700 hover:before:grayscale-0`;

const textBoxStyles = `relative space-y-3 rounded-b-md bg-white bg-center py-7 text-center shadow-xl before:absolute before:right-1/2 before:top-[-26px] before:z-10 before:h-8 before:w-28 before:translate-x-1/2 before:bg-[url('./images/trainers/shape.png')] before:bg-no-repeat after:absolute after:bottom-0 after:right-1/2 after:h-1 after:w-10 after:translate-x-1/2 after:bg-yellow-500 after:transition-all after:duration-500 hover:after:w-full after:hover:rounded-b-md`;

const iconStyles = `transition-all duration-300 hover:text-black`;

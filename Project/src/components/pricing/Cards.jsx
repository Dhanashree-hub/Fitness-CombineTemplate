...
const headingStyles = `clip-path-left group-hover:clip-path-right absolute bottom-[-1px] right-1/2 w-3/4 translate-x-1/2 bg-white py-5 text-lg font-bold text-yellow-500 transition-all duration-500 group-hover:bg-yellow-500 group-hover:text-white`;
